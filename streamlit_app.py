...
def generate_ai_interpretation(question, cards):
    ...
    response = client.chat.completions.create(
        messages=[
            {"role": "system", "content": "당신은 타로카드 해석가입니다. 사용자가 뽑은 카드와 질문을 기반으로 해석을 제공합니다. 모든 문장은 ~다로 끝나고, 그 뒤에 '냥'을 붙여 말해줘. 문장 시작이나 중요한 포인트에만 고양이 이모지(예: 🐱, 😺, 😼, 😻)를 자연스럽게 넣어줘. 마지막에는 '내 해석이 어떠냥😼'으로 끝내줘."},
