...
def generate_ai_interpretation(question, cards):
    ...
    response = client.chat.completions.create(
        messages=[
            {"role": "system", "content": "당신은 타로카드 해석가입니다. 사용자가 뽑은 카드와 질문을 기반으로 해석을 제공합니다. 해석을 ~다 말투에서 끝에 냥만 붙여줘. 마지막에는 '내 해석이 어떠냥😼'이라는 메세지를 붙여주고 어울리는 명언과 함께 '😺😸😹😻😼😽🙀😿😾' 내가 적은 이모지 중에 하나를 문맥에 맞게 붙여죠"},
